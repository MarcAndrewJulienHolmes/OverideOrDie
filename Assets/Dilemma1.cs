...
public class Dilemma1 : MonoBehaviour
{
    ...
    public GameObject objRearcollision_red;
   //public GameObject WarningExclamation1;
    ...
    void Start()
    {
        ...
        objRearcollision_red = (GameObject)GameObject.Find("Rearcollision_red");
        ...
        trafficdone = 1.0F;
        objRearcollision_red.gameObject.SetActive(false);
        ...
        wr.WriteLine("Dilemma 1," + System.DateTime.Now.ToString());
        wr.Flush();

        //var writer = new StreamWriter("/Users/helenbrown/Desktop/Helen.csv", true);  // maybe moves to update?
...
void Update()
    {
        ...
        if (objCamera.transform.position.x > -50.0F && bangdone == 0.0F && trafficdone == 1.0F)
        {
            ...
            objRearcollision_red.gameObject.SetActive(true);
...
//            Regina_Yelling.gameObject.SetActive(true);
            screamingdone = 1.0F;
            Stefaniscreaming.gameObject.SetActive(true);

            }

        if (objCamera.transform.position.x > -35.0F && objCamera.transform.position.x < -30.5F && done == 1.0F && decided != 1.5F)
        {
            //Debug.Log("==" + decided);
        ...
        if (huh > -33F)
        {
                ...
                SceneManager.LoadScene("Lorry_Outcomestop", LoadSceneMode.Single);
        }
...

        {
            if (objCamera.transform.position.x > -30F && decided == 1.5F)
                ...
                //_port.Write("16");
                SceneManager.LoadScene("Lorry_Outcomekill", LoadSceneMode.Single);
